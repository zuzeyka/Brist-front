                ...
                <div className="flex flex-col space-y-4">
                    ...
                    {screenshotsUrl.length == 2 ? (<img className="w-full h-96 object-cover rounded-2xl" src={screenshotsUrl[1]} alt="Game screenshot"></img>) : (
                        <div className="flex space-x-2">
                            ...
                            {screenshotsUrl.length > 3 ? (<div className="h-32 w-1/3 object-cover rounded-2xl bg-cardLight25 flex items-center justify-center text-typographySecondary text-sign-1">+{screenshotsUrl.length - 3}</div>) : null}
                        </div>
                    )}
                </div>
            </div>
