    ...
    return (
        <>
            ...
            <div className="max-w-7xl mx-auto bg-white grid grid-cols-4 grid-rows-2">
                {userBackgroundUrl ? <img src={userBackgroundUrl} alt="User background" className="w-full h-40 object-cover col-span-4" /> : <div className="w-full h-full bg-gradient-to-br from-gray-500 via-gray-700 to-gray-900 col-span-4"></div>}
