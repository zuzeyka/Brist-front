        ...
        <div className="flex flex-col px-10 py-8 rounded-3xl bg-zinc-100 max-md:px-5">
            <div className="flex gap-5 justify-between text-black max-md:flex-wrap max-md:max-w-full">
                <div className="flex flex-col max-md:max-w-full">
                    <div className="text-xl max-md:max-w-full">Ваш гайд</div>
            ...
            <div className="mt-8 max-md:max-w-full">
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                    <div className="flex flex-col w-[65%] max-md:ml-0 max-md:w-full">
                        <div className="flex flex-col grow max-md:mt-6 max-md:max-w-full">
                            <div className="flex gap-2.5 justify-between px-3.5 py-2.5 text-black rounded-3xl bg-stone-300 max-md:flex-wrap max-md:max-w-full">
                                <div className="text-base">Заголовок гайда</div>
                                <div className="text-sm">0/300</div>
                            </div>
                            <div className="mt-4 text-xl text-black max-md:max-w-full">
                                Обкладинка
                            </div>
                            <div className="flex justify-center items-center px-4 py-20 mt-4 text-black rounded-3xl border-2 border-black border-dashed bg-stone-300 max-md:px-5 max-md:max-w-full">
                                <div className="flex gap-3 mt-7 mb-1.5">
                            ...
                            <div className="justify-center items-start px-3.5 py-2.5 mt-4 text-base text-black rounded-3xl bg-stone-300 max-md:pr-5 max-md:max-w-full">
                                Опис гайда
                            </div>
                            <div className="flex flex-col items-start p-4 mt-4 rounded-3xl bg-stone-300 max-md:pr-5 max-md:max-w-full">
                                ...
                                <div className="mt-5 mb-3.5 text-base text-black">
                                    Текст гайда
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col ml-5 w-[35%] max-md:ml-0 max-md:w-full">
                        <div className="flex flex-col text-black max-md:mt-6">
